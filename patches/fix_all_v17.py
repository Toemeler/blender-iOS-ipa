...
# ===================== build-17: rename-on-save + caret/bar fix + resize cursors =====================
...
print("BUILD-17 (rename-on-save + caret/bar + resize cursors) APPLIED OK")
